...
http_archive(
    name = "Unity",
    build_file = "@//:third-party/http/ThrowTheSwitch/Unity/BUILD",
...
http_archive(
    name = "CException",
    build_file = "@//:third-party/http/ThrowTheSwitch/CException/BUILD",
...
http_archive(
    name = "CMock",
    build_file = "@//:third-party/http/ThrowTheSwitch/CMock/BUILD",
...
new_local_repository(
    name = "glib",
    build_file = "./third-party/brew/gnu-lib/glib.BUILD",
