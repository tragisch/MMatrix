...
/*
  Purpose:
    ...
    MAIN is the main program for CC_IO_TEST.
...
#define NCC 12
  ...
  double acc[NCC] = {2.0,  3.0, 3.0, -1.0, 4.0, 4.0,
                     -3.0, 1.0, 2.0, 2.0,  6.0, 1.0};
  int ccc[N + 1] = {1, 3, 6, 10, 11, 13};
  int icc[NCC] = {1, 2, 1, 3, 5, 2, 3, 4, 5, 3, 2, 5};
  int m = N;
  int n = N;
  int ncc = NCC;
  char prefix[] = "data/simple"; // changed to folder data (UR 07/06/23)
